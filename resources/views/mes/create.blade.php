...
<body>
  ...
  <button type="button" class="btn btn-success"><a href='{{url("mes/create")}}' style="text-decoration:none">Crear Nuevo</a></button>

  <form method="POST" action="{{ url('mes/store')}}">
    <fieldset>
      <legend>Mes Nuevo</legend>
      <div class="form-group">
        <label for="exampleInputEmail1">Mes</label>
        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Mes" name="mes">
      </div>
