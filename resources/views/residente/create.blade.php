...
<body>
  ...
  <button type="button" class="btn btn-success"><a href='{{url("residente/create")}}' style="text-decoration:none">Crear Nuevo</a></button>

  <form method="POST" action="{{ url('residente/store')}}">
    <fieldset>
      <legend>Residente Nuevo</legend>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" aria-describedby="emailHelp" name="nit">
      </div>
      <div class="form-group">
